...
def GetPxPowerDB(a, b):  
    #return abs(DEFAULT_CS_THRESHOLD + GetPathLossDB(GetDist(a, b)) + MARGIN) 
    #eturn REFERENCE_TX_POWER + GetPathLossDB(GetDist(a, b)) + MARGIN
    return GetRxPowerDB(a, b) - DEFAULT_CS_THRESHOLD
...
#++++++++++++++++++++++++adding++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
param_tx_power = REFERENCE_TX_POWER #20
#++++++++++++++++++++++++adding++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        for j in range(param_num_aps):
            ...
            if mem[j,i]==1:
                ...
                if mydistance <= divdist:
                    ...
                    #my_px = param_tx_power + GetPathLossDB(GetDist(aps[j], mss[i]))+MARGIN
                    # my_px= GetPxPowerDB(aps[j], mss[i])
                    # print(my_px, "=============================")
                    
                    # REFERENCE_TX_POWER= GetPxPowerDB(aps[j], mss[i])
                    # print(REFERENCE_TX_POWER, "=============================")
                    
                    # GetPxPowerDB(aps[j], mss[i])
                    # print(GetPxPowerDB(aps[j], mss[i]), "=============================")
                    
                    REFERENCE_TX_POWER = 12
                    print(REFERENCE_TX_POWER)
