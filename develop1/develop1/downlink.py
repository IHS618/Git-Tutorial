...
def GetPxPowerDB(a, b):  
    return abs(DEFAULT_CS_THRESHOLD + GetPathLossDB(GetDist(a, b)) + MARGIN)   #조금 이상..
    #return GetRxPowerDB(a, b) + GetPathLossDB(GetDist(a, b))+MARGIN
            ...
            for j in range(param_num_aps):
                ...
                if mem[j,i]==1:
                    ...
                    if mydistance <= divdist:
                        ...
                        ch=3
                        #print("ch==3", ch)
                        #REFERENCE_TX_POWER= GetPxPowerDB(aps[j], mss[i])   #조금 이상함...
                        #print(REFERENCE_TX_POWER)
